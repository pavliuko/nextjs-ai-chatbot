...
export const PumaIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M336.691 156.871C337.917 133.042 319.114 118.674 301.011 105.65C289.274 34.9209 179.256 35.9722 150 38.6588C92.4217 0.578536 27.8945 -1.05681 21.471 1.98027C20.0111 7.17835 21.0038 72.4756 39.3985 110.439C39.3985 110.439 10.9014 126.851 0.0397797 164.347C23.5148 130.005 68.4211 118.849 68.4211 118.849C53.0046 85.2079 45.3548 28.6715 47.3403 28.9052C105.21 34.9793 145.387 62.2546 145.387 62.2546C260.893 57.5822 275.025 98.466 277.653 119.141C312.749 143.263 315.844 155.002 313.274 164.23C313.216 164.347 313.216 164.522 313.157 164.639C312.982 165.165 312.807 165.691 312.632 166.216H312.69C303.872 194.484 286.471 220.241 286.762 221.292C290.091 233.09 293.303 277.362 246.178 279.932C238.644 211.13 144.919 269.185 133.415 315.617C159.226 280.574 232.747 243.895 226.557 303.703C317.011 304.17 317.07 245.823 311.639 226.023C332.253 191.856 337.1 162.303 336.691 156.871Z"
        fill="currentColor"
      />
      <path
      fillRule="evenodd"
      clipRule="evenodd" 
      d="M71.1073 143.321C47.6906 149.687 26.493 162.478 3.60188 192.44H23.982C13.6459 210.721 9.09108 225.731 10.9013 252.948C22.1717 219.014 48.8001 189.403 72.5088 170.947H43.6613L71.1073 143.321Z" 
      fill="currentColor"/>
    </svg>
  );
};
